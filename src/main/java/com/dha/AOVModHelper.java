            ...
            case 13210:
                switch (fileName) {
                    ...
                    case "S12B0.xml":
                        ...
                        CustomNode.appendEventNode(xml.getTrackNodeByType("ChangeAnimDuration", false).get(changeAnimTrackIndex), 
                        CustomNode.newNode("<bool name=\"bUseDirectionalMove\" value=\"true\" refParamName=\"\" useRefParam=\"false\" />"));
                        break;
                }
                break;
            case 13099:
